...
"""Diskmat, the mandatory Discrete Mathematics course taught by Professor Ueli Maurer, was surprisingly engaging. It enhanced logical thinking but required substantial effort. The course materials, particularly the script, were a lifeline, while the lectures sometimes added confusion. The exam, overseen by Professor Maurer, was tough but served as a solid test of knowledge. In the end, a challenging yet rewarding experience.""",
                      """Discrete Mathematics, often referred to as Diskmat, is a challenging course that many students find difficult in their first semester. It is notorious for its emphasis on formal proofs, a topic that tends to be a major struggle for most. The course is taught by Ueli Maurer, who has been instructing it for numerous years. To succeed, it's advisable to begin your exam preparations well in advance, as there is an abundance of past exam materials to review. It's perfectly normal if you can't solve most exercises right away, so don't be discouraged.""",
                      """A mathematics-heavy and quite demanding course. Investing the time to really get into new mathematics and solve the series can feel insane, but gives insight into 'true' mathematical thinking and a foundation for mathematical logic. The script is one of the best course scripts at ETH, and Prof. Maurer is engaged to introduce its ideas, and also motivate otherwise.""",
                      """Feels like a lot of content and the exam is very stressful & difficult. I found the lectures & content to be somewhat interesting, though they tended to be a lot easier than exercises/exams. However, there is a good script to use and there are a lot of old exams to practice on.""",
                      """Covers a lot of content and the exam is generally regarded as very stressful & difficult. Students consider the lectures and content to be somewhat interesting, though they are often a lot easier than exercises/exams. However, there is a good script to use and there are a lot of old exams to practice on."""]
